...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/backblaze-b2-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/backblaze-b2-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add backblaze-b2
# for installing globally
pixi global install backblaze-b2
```
...
It is possible to list all of the versions of `backblaze-b2` available on your platform:
...
```
pixi search backblaze-b2 --channel conda-forge
```
